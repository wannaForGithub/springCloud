...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir(projectPath+"/product-service/src/main/java");
        ...
        packageConfig.setParent("com.example.productserver");
        ...
        fileOutConfigs.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/product-service/src/main/resources/mapper/" + packageConfig.getModuleName()
